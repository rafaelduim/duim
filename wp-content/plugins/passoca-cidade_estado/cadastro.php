<?php
/*
Plugin Name: Passoca Cidade/Estado Brasileiro
Plugin URI: http://www.rafealduim.com.br/
Description: Plugin de criação de tabela de cidade e estado do Brasil desenvolvido por RafaelDuim
Version: 1.0.5
Author: RafaelDuim
...
include('incs/class/PsnLocation.php');

include('incs/functions.php');


register_activation_hook( __FILE__, 'psn_city_state' );


function psn_city_state() {
   global $wpdb;

    $table_city = $wpdb->prefix . 'psn_city';

    $create_table_city = "CREATE TABLE $table_city (
        state_cod_state int(11) DEFAULT NULL,
  		cod_city int(11) DEFAULT NULL,
  		name varchar(72) COLLATE utf8_unicode_ci DEFAULT NULL,
  		cep varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL
	) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci; ";
	// Executando a query
    $wpdb->query($create_table_city);

    $table_state = $wpdb->prefix . 'psn_state';

    $create_table_state = "CREATE TABLE $table_state (
        cod_state int(11) DEFAULT NULL,
	  	sigla varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL,
	  	name varchar(72) COLLATE utf8_unicode_ci DEFAULT NULL
	) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci; ";
	// Executando a query
    $wpdb->query($create_table_state);

    $wpdb->query("
        INSERT INTO $table_state (cod_state, sigla, name) VALUES 
            (1, 'AC', 'ACRE'),
            (2, 'AL', 'ALAGOAS'),
            (3, 'AP', 'AMAPÁ'),
            (4, 'AM', 'AMAZONAS'),
    ...
    $wpdb->query("
        INSERT INTO $table_city (state_cod_state, cod_city, name, cep) VALUES 
...
register_deactivation_hook( __FILE__, 'psn_city_state_remove' );

function psn_city_state_remove() {
	global $wpdb;
    ...
    $sql_del = "DROP TABLE IF EXISTS $table_city ";
    $wpdb->query($sql_del);
    $sql_del2 = "DROP TABLE IF EXISTS $table_state ";
    $wpdb->query($sql_del2);
