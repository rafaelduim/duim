...
class SMTP
{
    ...
    /**
     * Debug level to show connection stats, client -> server and server -> client messages
     */
     ...
     * * self::DEBUG_CONNECTION (`3`) As DEBUG_SERVER plus connection stats
    ...
    {
        if (is_resource($this->smtp_conn)) {
            $sock_stats = stream_get_meta_data($this->smtp_conn);
            if ($sock_stats['eof']) {
